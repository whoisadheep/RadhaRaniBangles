          ...
          <div>
            ...
            >
              <input
                ...
                className="flex-1 bg-white/10 border border-white/15 rounded-l-md px-4 py-2.5 text-sm font-body text-white placeholder:text-white/30 outline-none focus:border-accent transition-colors duration-300"
